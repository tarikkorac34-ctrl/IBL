...
// Starts immediately on 0.0.0.0 so Render detects it on launch
// ==========================================
...
// Schemas for permanent database storage
...
// Seed MongoDB with team records if the collection is empty
...
client.on('interactionCreate', async (interaction) => {
  ...
  if (commandName === 'results') {
    ...
    // Save match result history to MongoDB permanently
  ...
  if (commandName === 'standings') {
    ...
    try {
      // Pull standings directly from MongoDB, sorted by points & goal difference
...
// Function to update standings inside MongoDB
